...
from services.chapter import get_chapters, get_latest_chapter, get_chapter, create_chapter, update_chapter, delete_chapter, delete_chapters
...
@router.get("/getLatestChapter/{story_id}")
def get_latest_chapter_by_story_id(story_id: str):
    return get_latest_chapter(story_id)
